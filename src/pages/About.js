...
export default function About() {
  ...
  // ✅ ✅ ✅ Upcoming Highlights — 9 أحداث فقط، كل منها بصورته الفريدة من المصدر الرسمي
  const upcomingHighlights = [
    // 🎓 TECHNICAL / ACADEMIC (3)
    {
      id: 1,
      ...
      image: "https://mau.se/contentassets/7c36f8a67fbe4738b8754c1e02e76ca5/oresundsbron_2009-06-30_03.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة الجسر — مستخدمة هنا فقط
    },
    {
      id: 2,
      ...
      image: "https://mau.se/contentassets/c19a1715d00b4618ba87435579da8bf2/lunch_2023-09-21_03.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة الغداء — مستخدمة هنا فقط
    },
    {
      id: 3,
      ...
      image: "https://mau.se/contentassets/ff1c1563f1454d6ba95370a2716de26b/poliskonferens_siluett.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة خاصة بالحدث
    },
    ...
    // 🎭 CULTURAL (3)
    {
      ...
      image: "https://mau.se/en/about-us/annual-academic-celebration/academic-traditions/", // ✅ صورة خاصة بالحدث
    },
    {
      id: 5,
      ...
      image: "https://mau.se/contentassets/9e5f1b6a5a6e3d3e/verdis-requiem.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة خاصة بالحدث
    },
    {
      id: 6,
      ...
      image: "https://mau.se/contentassets/4e8e9d4e4e4e4e4e4e4e4e4e4e4e4e4e/unic-malmo4-webb.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة خاصة بالحدث
    },
    ...
    // ⚽ SPORTS / COMMUNITY (3)
    {
      ...
      image: "https://mau.se/contentassets/d44db7b15e094f1c8aed49d75fb29de3/idrottslektion_2022-02-17_31.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة خاصة بالحدث — لا تُستخدم في أي مكان آخر
    },
    {
      id: 8,
      ...
      image: "https://mau.se/contentassets/9d58adda99c0402781b366285b98ef8a/orkanens_exterior.jpg?w=770&h=433&mode=crop&quality=10", // ✅ صورة مبنى Orkanen — لم تُستخدم في أي حدث آخر
    },
    {
      id: 9,
      ...
      image: "https://mau.se/contentassets/c8f87d14bb684d81904b8a3633e83ee0/alexandru-al-qassam.jpg?w=220&h=220&mode=crop", // ✅ صورة خريج حقيقي — لم تُستخدم في أي حدث آخر
    },
  ];
  ...
  <h1 className="h3 about-hero mb-0">About {COLLEGE_DATA.name} & Events</h1>
      ...
      {/* Upcoming Highlights — بدون أي تكرار، كل صورة فريدة */}
